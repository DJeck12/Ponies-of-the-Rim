    ...
    public class ThoughtWorker_Precept_StrictRaces : ThoughtWorker_Precept
    {
        ...
        private ThoughtExtension Extension
        {
            get
            {
                if (!extensionCached)
                {
                    ...
                    {
                        Log.ErrorOnce(
                            "[PoniesOfTheRim] ThoughtWorker_Precept_StrictRaces: ThoughtExtension не найден на ThoughtDef '"
        ...
        protected override ThoughtState ShouldHaveThought(Pawn p)
        {
            ...
            if (lord != null)
            {
                ...
                {
                    Pawn c = owned[i];
                    if (c.def != race && c.RaceProps.intelligence == Intelligence.Humanlike && c.IsFreeNonSlaveColonist)
                    {
                        return true;
                    }
                }
            ...
            if (map != null)
            {
                ...
                else
                {
                    ...
                    {
                        Pawn c = list[i];
                        if (c.def != race && !p.HostileTo(c) && c.RaceProps.intelligence == Intelligence.Humanlike && c.IsFreeNonSlaveColonist)
                        {
                            return true;
                        }
                    }
